...
For reuse across Codex accounts, see
[`docs/CODEX_AGENT_KIT.md`](docs/CODEX_AGENT_KIT.md). It explains how to clone
this repo, install the bundled Codex skills from [`skills`](skills), and start a
new session with the same cell-biology production rules.
