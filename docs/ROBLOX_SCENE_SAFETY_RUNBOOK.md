...
## V3 Recovery Baseline Policy

`CellClassroom_V3` is the named recovery baseline for the current classroom
experience. The live runtime root remains `Workspace.CellClassroom_V7_Dev` for
compatibility with existing scripts and telemetry.

V3 owns only:

- `Workspace.CellClassroom_V7_Dev`
- `ReplicatedStorage.CellClassroomV7DevRemotes`
- `ServerScriptService.CellClassroomV7DevController`
- `StarterPlayer.StarterPlayerScripts.CellClassroomV7DevClient`
- `SoundService.CellClassroom_V7_Dev_GlobalAudio`

The recovery source of truth is:

- `releases/cell_classroom_v3_recoverable_2026-05-14/`
- `tools/restore_cell_classroom_v3.py`
- `tools/install_cell_classroom_v7_dev.py`

Before a new classroom iteration begins, confirm whether V3 should be preserved
unchanged or superseded by a new named bundle. Never overwrite the V3 recovery
bundle with unreviewed work.
